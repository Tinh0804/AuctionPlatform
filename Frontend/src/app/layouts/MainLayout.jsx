...
const MainLayout = () => {
  ...
  const walletBalance = profile?.wallet?.available_balance ?? profile?.wallet?.availableBalance ?? 0;
  const accountRole = profile?.account?.role?.name || profile?.account?.role;
