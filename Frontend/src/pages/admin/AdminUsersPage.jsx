        ...
        try {
            ...
            if (selectedUser && selectedUser.id === id) {
                setSelectedUser(prev => ({
                    ...
                    account: {
                        ...prev.account,
                        active: !(prev.account?.active ?? prev.account?.isActive),
                        isActive: !(prev.account?.active ?? prev.account?.isActive)
                    }
                }));
            }
            fetchUsers();
                            ...
                            {loading ? (
                                ...
                                users.map(user => (
                                    <tr key={user.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            {(user.account?.active ?? user.account?.isActive) ? (
                                    ...
                                    <div className="pt-2">
                                        <button 
                                            ...
                                            className={`w-full py-2.5 rounded-xl font-medium text-sm flex items-center justify-center gap-2 transition-all ${
                                                (selectedUser.account?.active ?? selectedUser.account?.isActive)
                                        ...
                                        {selectedUser.wallet ? (
                                            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-5 text-white shadow-lg relative overflow-hidden">
                                                ...
                                                <div className="flex justify-between items-start mb-4 relative z-10">
                                                    <div>
                                                        ...
                                                        <p className="text-2xl font-bold font-mono">
                                                            {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(selectedUser.wallet.availableBalance ?? selectedUser.wallet.available_balance ?? 0)}
                                                        </p>
                                                    </div>
                                                ...
                                                <div className="flex justify-between items-center text-sm relative z-10 pt-4 border-t border-gray-700/50">
                                                    <span className="text-gray-400">Đóng băng: {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(selectedUser.wallet.frozenBalance ?? selectedUser.wallet.frozen_balance ?? 0)}</span>
