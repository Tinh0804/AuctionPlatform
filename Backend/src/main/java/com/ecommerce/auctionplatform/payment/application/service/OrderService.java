...
import com.ecommerce.auctionplatform.user.infrastructure.persistence.repository.ReputationHistoryRepository;
import com.ecommerce.auctionplatform.user.infrastructure.persistence.repository.RoleRepository;
import com.ecommerce.auctionplatform.auction.infrastructure.persistence.repository.AuctionRecordRepository;import com.ecommerce.auctionplatform.shared.presentation.advice.ErrorCode;
import com.ecommerce.auctionplatform.user.infrastructure.persistence.repository.*;
import com.ecommerce.auctionplatform.product.infrastructure.persistence.repository.*;
import com.ecommerce.auctionplatform.auction.infrastructure.persistence.repository.*;
import com.ecommerce.auctionplatform.payment.infrastructure.persistence.repository.*;
import com.ecommerce.auctionplatform.dispute.infrastructure.persistence.repository.*;
import com.ecommerce.auctionplatform.notification.infrastructure.persistence.repository.*;
