package com.ecommerce.auctionplatform.user.application.service;

import com.ecommerce.auctionplatform.user.presentation.dto.request.AddressRequest;
import com.ecommerce.auctionplatform.user.presentation.dto.request.PhoneUpdateRequest;
import com.ecommerce.auctionplatform.user.presentation.dto.request.UserUpdateRequest;
import com.ecommerce.auctionplatform.user.application.dto.response.AddressDto;
import com.ecommerce.auctionplatform.user.application.dto.response.UserResponse;
import com.ecommerce.auctionplatform.user.application.dto.response.WalletResponse;
import com.ecommerce.auctionplatform.user.domain.model.Address;
...
import com.ecommerce.auctionplatform.user.infrastructure.persistence.repository.AddressRepository;
